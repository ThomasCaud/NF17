...
$sql = "select exploitation.modeculture, round(sum(assemblage.pourcentage*vin.prix)/(sum(assemblage.pourcentage)),2) as prixmoyen from vin 
...
$query = $pdo->query($sql);
$prixMoyenModeCulture = $query->fetchAll();
